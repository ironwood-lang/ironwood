...
| Public option, collectors, and witnesses | M1d has a nullable bounded collector, source origins, local-binding sites, accepted selected-reason event identities, current earlier-free sites, and forced-limit tests; see the [M1d record](EXPLAIN_REJECTED_FREE_VERIFICATION.md#m1d-pre-change-selection-2026-09-24). No public option or nonlocal witnesses yet. | Complete M1d's cost gate before M1e; source operations for selected reasons and later witnesses remain M2 through M4. |
