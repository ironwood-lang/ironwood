...
| N1 Milestones 1 through 3 TCP/address/host foundation | Independent Java-compatible facades plus original compiler/runtime mechanisms | `MIT OR Apache-2.0` | Prior OpenJDK source inspection disclosed in [STDLIB_N1_SOURCE_REVIEW.md](STDLIB_N1_SOURCE_REVIEW.md); no upstream implementation, comments or tests copied. The private IP literal helper introduced in Milestone 2 is separately classified below; SOCKS remains unimplemented. |
...
private IP literal parser below are OpenJDK-derived.
