...
| N1 Milestone 1 TCP foundation | Independent Java-compatible facades plus original compiler/runtime mechanisms | `MIT OR Apache-2.0` | Prior OpenJDK source inspection disclosed in [STDLIB_N1_SOURCE_REVIEW.md](STDLIB_N1_SOURCE_REVIEW.md); no upstream implementation, comments or tests copied. Future private IP/SOCKS derived helpers remain unimplemented and separately classified. |
