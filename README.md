...
For a rejected `free`, use `--explain-rejected-free` to request the compiler or linker's supported evidence for the rejection; see the [worked compile and link examples](docs/EXPLAIN_REJECTED_FREE_EXAMPLES.md) and [memory management guide](docs/MEMORY_MANAGEMENT.md).
