...
java -cp "$IRONWOOD_JAR" ironwood.compiler.IronJarMain \
    ...
    --license "$IRONWOOD_PROJECT_ROOT/docs/NETWORKING_MIGRATION_PLAN.md" \
    --license "$IRONWOOD_PROJECT_ROOT/docs/STDLIB_N1_SOURCE_REVIEW.md" \
    --license "$IRONWOOD_PROJECT_ROOT/docs/STDLIB_N1_VERIFICATION.md" \
