...
cp "$IRONWOOD_PROJECT_ROOT/LICENSE_MECHANICS" "$IRONWOOD_STAGE_DIR/LICENSE_MECHANICS"
...
cp "$IRONWOOD_PROJECT_ROOT/THIRD_PARTY_NOTICES.md" "$IRONWOOD_STAGE_DIR/THIRD_PARTY_NOTICES.md"
