...
cp "$IRONWOOD_PROJECT_ROOT/docs/QUICK_START.md" "$IRONWOOD_STAGE_DIR/docs/QUICK_START.md"
...
cp "$IRONWOOD_PROJECT_ROOT/docs/NETWORKING_MIGRATION_PLAN.md" "$IRONWOOD_STAGE_DIR/docs/NETWORKING_MIGRATION_PLAN.md"
cp "$IRONWOOD_PROJECT_ROOT/docs/STDLIB_N1_SOURCE_REVIEW.md" "$IRONWOOD_STAGE_DIR/docs/STDLIB_N1_SOURCE_REVIEW.md"
cp "$IRONWOOD_PROJECT_ROOT/docs/STDLIB_N1_VERIFICATION.md" "$IRONWOOD_STAGE_DIR/docs/STDLIB_N1_VERIFICATION.md"
cp "$IRONWOOD_PROJECT_ROOT/docs/NETWORKING_M2_VERIFICATION.md" "$IRONWOOD_STAGE_DIR/docs/NETWORKING_M2_VERIFICATION.md"
cp "$IRONWOOD_PROJECT_ROOT/docs/NETWORKING_M3_VERIFICATION.md" "$IRONWOOD_STAGE_DIR/docs/NETWORKING_M3_VERIFICATION.md"
