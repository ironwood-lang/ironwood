...
public record LocalVariableDeclaration(TypeName type, boolean isFinal, boolean hasSuppressUnfreedDirective,
                                       String name, SourceSpan nameSpan,
                                       Expression initializer, SourceSpan span) implements Statement {
    public LocalVariableDeclaration(TypeName type, boolean isFinal, String name, SourceSpan nameSpan,
                                    Expression initializer, SourceSpan span) {
        this(type, isFinal, false, name, nameSpan, initializer, span);
    }
