...
public final class Bench {
    ...
    static long run(OrderBook book, long cycles, long nextOrderId) {
    ...
    static void verify(OrderBook book, long nextOrderId, long totalCycles) {
    ...
    public static void main(String[] args) {
        ...
        long nextOrderId = run(book, (long) warmupMillions * CYCLES_PER_MILLION, 1L);

        long start = System.nanoTime();
        nextOrderId = run(book, (long) measuredMillions * CYCLES_PER_MILLION, nextOrderId);
